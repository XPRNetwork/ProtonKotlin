...
interface EOSChainService {
	@POST//("/v1/history/get_key_accounts")
	fun getKeyAccounts(
		@Url url: String,
		@Body body: KeyAccountsBody): Call<KeyAccount>

	@GET//("/v2/state/get_key_accounts?public_key=")
	fun getStateHistoryKeyAccounts(
		@Url url: String,
		@Query("public_key") publicKey: String): Call<KeyAccount>

	@POST//("/v1/history/get_key_accounts")
	suspend fun getKeyAccountsAsync(
		@Url url: String,
		@Body body: KeyAccountsBody): Response<KeyAccount>

	@GET//("/v2/state/get_key_accounts?public_key=")
	suspend fun getStateHistoryKeyAccountsAsync(
		@Url url: String,
		@Query("public_key") publicKey: String): Response<KeyAccount>

	@POST//("/v1/chain/get_currency_balance")
	suspend fun getCurrencyBalanceAsync(
		@Url url: String,
		@Body body: CurrencyBalanceBody): Response<JsonArray>

	@POST//("/v1/chain/get_currency_balances")
	suspend fun getCurrencyBalancesAsync(
		@Url url: String,
		@Body body: CurrencyBalancesBody): Response<JsonArray>

	@GET//("/v2/state/get_tokens?account=")
	suspend fun getStateHistoryCurrencyBalancesAsync(
		@Url url: String,
		@Query("account") account: String): Response<JsonObject>

	@POST//("/v1/history/get_actions")
	suspend fun getActionsAsync(
		@Url url: String,
		@Body body: ActionsBody): Response<JsonObject>
	...
	suspend fun getStateHistoryActionsAsync(
		...
		@Query("limit") limit: Int): Response<JsonObject>

	@POST//("/v1/chain/get_account")
	suspend fun getAccountAsync(
		@Url url: String,
		@Body body: AccountBody): Response<Account>

	@POST//("/v1/chain/abi_json_to_bin")
	fun jsonToBin(
		@Url url: String,
		@Body body: JsonToBinBody): LiveData<ApiResponse<JsonToBinResponse>>
	...
	fun getRequiredKeys(
		@Url url: String,
		@Body body: RequiredKeysBody): LiveData<ApiResponse<RequiredKeysResponse>>
	...
	suspend fun getTableRows(
		@Url url: String,
		@Body body: TableRowsBody): Response<JsonObject>
}